        ...
        <form method="POST" enctype="multipart/form-data" class="card shadow-sm p-4">
            <div class="mb-3 text-center">
                <div class="image-container">
                    ...
                    <?php else: ?>
                        <img id="profileImage" src="./assets/images/default-profile.png" alt="Profile" class="profile-img-small mb-2">
                    <?php endif; ?>
                    <div class="edit-overlay">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                            <path d="M12.146.146a.5.5 0 0 1 .708 0l2.854 2.854a.5.5 0 0 1 0 .708l-9.793 9.793a.5.5 0 0 1-.168.11l-4 1.5a.5.5 0 0 1-.65-.65l1.5-4a.5.5 0 0 1 .11-.168l9.793-9.793zM11.207 2L3 10.207V13h2.793L14 4.793 11.207 2z" />
                        </svg>
                    </div>
                </div>
